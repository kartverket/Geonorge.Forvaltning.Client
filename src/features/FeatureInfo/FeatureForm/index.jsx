...
export default function FeatureForm({ feature, onSave, onCancel, onDelete }) {
   ...
   useEffect(() => {
      ...
      dispatch(
         toggleEditor(geometryType !== GeometryType.Point ? geometryType : null)
      );
   ...
   const geometryTypeOptions = useMemo(() => {
      return Object.entries(GEOMETRY_TYPES).map((entry) => ({
         value: entry[1],
         label: entry[0],
      }));
   }, []);
   ...
   function getGeometryType() {
      const geometryType =
         feature.getGeometry()?.getType() || feature.get("_geomType");
   ...
   function getDefaultValues() {
      ...
      return {
         ...
         coordinates:
            coordinates !== null ? `${coordinates[1]}, ${coordinates[0]}` : "",
      };
   }
      ...
      <>
         ...
         <div className={styles.form}>
            ...
            <div className={styles.buttonsBottom}>
               <div
                  style={{
                     visibility: properties.id.value ? "visible" : "hidden",
                  }}
               >
