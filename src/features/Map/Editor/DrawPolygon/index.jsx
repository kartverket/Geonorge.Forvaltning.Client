...
import { getInteraction, readGeometry, writeFeatureObject, writeGeometryObject } from 'utils/helpers/map';
...
DrawPolygon.addInteraction = map => {
   ...
   interaction.on('drawend', event => {
      ...
      if (existingGeometry !== null && (existingGeometry.type === GeometryType.Polygon || existingGeometry.type === GeometryType.MultiPolygon)) {
